...
local url = "https://github.com/AdmBrookhavenScripts/Sonic/raw/refs/heads/main/videoplayback-_3_%20(1).mp3"
local file = "doomtheme.mp3"
...
doomtheme.Name = "doomtheme"
doomtheme.Looped = true
doomtheme.SoundId = getcustomasset(file)
doomtheme:Play()
doomtheme.Loaded:Wait()
else
doomtheme = Instance.new("Sound", Torso)
doomtheme.Volume = 3
doomtheme.Name = "doomtheme"
